      ...
      <div className="w-full max-w-4xl bg-white rounded-xl shadow-2xl overflow-hidden transform transition-transform duration-500 hover:shadow-3xl">
        ...
        <div className="bg-indigo-600 p-8 sm:p-10 flex flex-col md:flex-row items-center justify-center md:justify-start space-y-4 md:space-y-0 md:space-x-8">
          ...
          <div className="relative w-32 h-32 flex-shrink-0">
            ...
            <span
              className="absolute bottom-1 right-1 block h-4 w-4 rounded-full ring-2 ring-white bg-green-400 animate-pulse"
              title="Available"
            ></span>
          </div>
          ...
          <div className="lg:col-span-2 p-6 sm:p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2">
              ...
              <ContactItem
                ...
                value={`${doctor.years_experience} Years`}
              />
              <ContactItem
                icon={Clock}
                label="Member Since"
            ...
            <div className="mt-8 pt-4 border-t border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed text-base">
                Dr. {doctor.name.split(" ")[0]} is a highly dedicated
                professional specializing in {doctor.specialty} with a focus on
                cutting-edge techniques and patient-centered care. With{" "}
                {doctor.years_experience} years of experience,{" "}
                {doctor.name.split(" ")[0]} is committed to delivering
                excellence and innovation in their field. They are currently
                accepting new clients and look forward to assisting you.
              </p>
          ...
          <div className="p-6 sm:p-8 bg-indigo-50">
            ...
            <div className="mt-8 p-4 bg-white rounded-lg border-l-4 border-green-500 shadow-inner">
              ...
              <p className="text-gray-600 text-sm mt-1">
                Dr. {doctor.name.split(" ")[0]} is available for consultation
                between 9:00 AM - 1:00 PM and 3:00 PM - 5:00 PM.
              </p>
            </div>
          </div>
        </div>
